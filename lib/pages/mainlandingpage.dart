      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items:  [
          BottomNavigationBarItem(
            icon: IconButton(onPressed: (){}, icon: Icon(Icons.file_copy,size: 35,)),
            label: '',
          ),
          BottomNavigationBarItem(
            icon: IconButton(onPressed: (){}, icon: Icon(Icons.home,size: 35,)),
            label: '',
          ),
          BottomNavigationBarItem(
            icon: IconButton(onPressed: (){}, icon: Icon(Icons.person,size: 35,)),
            label: '',
          ),
        ],
      ),
